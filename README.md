...
![_**Figure 4.** Comparison between actual bike usage data from 2019 and the predicted values using a multiple regression model._](images/Rough model 2019.png)
